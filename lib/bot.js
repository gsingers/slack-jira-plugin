                ...
                jiraApi.findIssue(jira, function (error, issue) {
                  ...
                  if (issue && self.config.post == true) {
                    ...
                    if (self.config.showIssueDetails && expandInfo) {
                      var firstDetails = (issue.fields.summary || issue.key);
                      if (!self.config.minimalDisplay) {
                         firstDetails = '>>> \n*Summary*\n' + firstDetails;
                      }
                      msg.push(firstDetails);
                      if (verbose) {
                        console.log(issue);
                      }
                  ...
                  var msgSeparator = '\n';
                  if (self.config.detailSeparator) {
                      msgSeparator = self.config.detailSeparator;
                  }
                  msg = msg.join(msgSeparator);
                  if (verbose) {
                    console.log(msg);
                  }
